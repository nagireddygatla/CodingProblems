...
public class BinarySearchTree_Opt {
	...
	static boolean checkBST(TreeNode root,Integer min,Integer max){
		...
		if(!checkBST(root.leftTree,min,root.val) || !checkBST(root.rightTree,root.val,max)){
			return false;
		}
		return true;
	}
		...
		public static void main(String [] args){
			...
			//BinaryTreeBalanced obj = new BinaryTreeBalanced();
